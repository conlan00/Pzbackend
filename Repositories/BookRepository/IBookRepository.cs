...
public interface IBookRepository
{
        ...
        Task<bool> setReturnTime(Borrow borrow,DateTime time, int ShelterId);
        ...
        Task<bool> addBookArrival(int userId, int bookId, int shelterID);
        Task<bool> GiveLike(int userId, int bookId);
